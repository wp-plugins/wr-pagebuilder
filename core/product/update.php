...
if ( ! class_exists( 'WR_Pb_Product_Update' ) ) :
 ...
 * @since    1.0.0
 */
class WR_Pb_Product_Update extends WR_Pb_Product_Info {
	/**
	...
	public static function hook() {
		...
		$plugins = array_unique( apply_filters( 'wr_pb_installed_product', array() ) );
	...
	protected static function action_links( $identification, $links ) {
		...
		$html = sprintf(
			__( "<a href='%s'>Please input Envato information to get product's updates</a>", WR_PBL ),
			$settings_link
		);
